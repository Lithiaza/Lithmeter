...
bool    ImGui_ImplDX11_CreateDeviceObjects()
{
    ...
    // Create the blending setup
    {
        ...
        // Preserve the actual coverage alpha in the swap-chain backbuffer.
        // The old INV_SRC_ALPHA/ZERO pair discarded opaque ImGui pixels,
        // making the meter look transparent even when transparency was off.
